...
def test_simple_resource_block_parse_resource_type(raw_terraform_block, sample_file_node):
    resource_block_content = raw_terraform_block("resource/simple_resource.tf", "resource")
...
def test_simple_resource_block_parse_resource_name(raw_terraform_block, sample_file_node):
    resource_block_content = raw_terraform_block("resource/simple_resource.tf", "resource")
    resource_block = ResourceBlock()
    resource_block.parse(resource_block_content[0], "terraform", sample_file_node)
...
def test_simple_resource_block_parse_resource_content(raw_terraform_block, sample_file_node):
    resource_block_content = raw_terraform_block("resource/simple_resource.tf", "resource")
    resource_block = ResourceBlock()
    resource_block.parse(resource_block_content[0], "terraform", sample_file_node)
...
def test_simple_resource_block_parse_resource_state_path(raw_terraform_block, sample_file_node):
    resource_block_content = raw_terraform_block("resource/simple_resource.tf", "resource")
    resource_block = ResourceBlock()
    resource_block.parse(resource_block_content[0], "terraform", sample_file_node)
...
def test_simple_submodule_resource_block_parse_state_path(raw_terraform_block, submodule_file_node):
    resource_block_content = raw_terraform_block("resource/simple_resource.tf", "resource")
    resource_block = ResourceBlock()
